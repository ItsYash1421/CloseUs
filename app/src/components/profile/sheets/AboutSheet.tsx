        ...
        <BottomSheet visible={visible} onClose={onClose} title="About" height={600}>
            <View style={styles.container}>
                ...
                <View style={styles.appInfo}>
                    ...
                    <Text style={styles.tagline}>Bringing couples closer, one moment at a time</Text>
                </View>
                ...
                <View style={styles.links}>
                    ...
                    <LinkItem
                        icon="star"
                        title="Rate Us"
                        onPress={() => handleOpenLink('https://play.google.com/store/apps/details?id=com.closeus')}
                    />
                    <View style={styles.divider} />
                    <LinkItem
                        icon="share"
