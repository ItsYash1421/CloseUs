...
export const NotificationsSheet: React.FC<NotificationsSheetProps> = ({
    ...
    const [lastToggled, setLastToggled] = useState<keyof NotificationPrefs | null>(null);
    ...
    const ToggleItem = ({
        ...
        <View style={[styles.toggleItem, disabled && styles.toggleItemDisabled]}>
            <View style={styles.toggleInfo}>
                ...
                <Text style={[styles.toggleDescription, disabled && styles.textDisabled]}>
                    {description}
                </Text>
            </View>
            {loading ? (
    ...
    return (
        <BottomSheet visible={visible} onClose={onClose} title="Notifications" height={450} scrollEnabled={false}>
