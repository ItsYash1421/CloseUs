        ...
        <View style={styles.container}>
            ...
            <View style={styles.grid}>
                ...
                <View style={styles.glassPanel}>
                    <Icon name="verified-user" size={24} color={COLORS.blue400} style={styles.icon} />
                ...
                {/* Style */}
                <View style={styles.glassPanel}>
                    <Icon name="near-me" size={24} color={COLORS.blue400} style={styles.icon} />
                ...
                {/* Anniversary */}
                <View style={styles.glassPanel}>
                    <Icon name="cake" size={24} color={COLORS.blue400} style={styles.icon} />
