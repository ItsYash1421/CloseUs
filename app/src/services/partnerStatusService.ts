            ...
            if (response.data) {
                ...
                if (partnerData.name !== undefined) {
                    ...
                    useCoupleStore.getState().setPartnerStatus({
                        ...
                        lastActive: partnerData.lastActive ? new Date(partnerData.lastActive) : null,
                    });

                    console.log('[PartnerStatus] Updated store. isOnline:', partnerData.isOnline);
                    ...
                    useCoupleStore.getState().setPartnerStatus({
                        ...
                        lastActive: innerData.lastActive ? new Date(innerData.lastActive) : null,
                    });
                    console.log('[PartnerStatus] Updated store (wrapped). isOnline:', innerData.isOnline);
                }
            }
        } catch (error: any) {
