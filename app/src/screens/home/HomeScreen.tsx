...
export const HomeScreen = ({ navigation }: any) => {
  ...
  return (
    ...
    >
      ...
      {!isKeyboardVisible && (
        <StickyHeader hashtag={couple?.coupleTag} scrollY={scrollY} />
      )}
          ...
          <View
            style={[
              styles.contentPadding,
              {
                ...
                marginTop: isKeyboardVisible ? 60 : THEME.spacing.xl,
              },
            ]}
          >
            ...
            {!isKeyboardVisible && (
              <View style={styles.quoteContainer}>
                <Text style={styles.quoteText}>
                  ...
                  Love isn't just about being together, it's about growing
                  together."
                </Text>
              </View>
            )}
