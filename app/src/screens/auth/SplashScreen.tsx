    ...
    useEffect(() => {
        ...
        if (!isLoading && !hasNavigated.current) {
            setTimeout(async () => {
                ...
                console.log('[SplashScreen] isOnboardingComplete:', user?.isOnboardingComplete);
                ...
                if (isAuthenticated && user) {
                    if (!user.isOnboardingComplete) {
                        console.log('[SplashScreen] Navigating to GenderSelection (onboarding not complete)');
                    ...
                    console.log('[SplashScreen] Navigating to Welcome (not authenticated)');
