...
export const RelationshipStatusScreen = ({ navigation }: any) => {
    const relationshipStatus = useOnboardingStore(state => state.relationshipStatus);
    const setRelationshipStatus = useOnboardingStore(state => state.setRelationshipStatus);
