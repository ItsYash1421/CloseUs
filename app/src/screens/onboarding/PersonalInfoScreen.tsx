...
export const PersonalInfoScreen = ({ navigation }: any) => {
  ...
  const [day, setDay] = useState(
    existingDob ? existingDob.getDate().toString().padStart(2, '0') : '',
  );
  const [month, setMonth] = useState(
    existingDob ? (existingDob.getMonth() + 1).toString().padStart(2, '0') : '',
  );
  const [year, setYear] = useState(
    existingDob ? existingDob.getFullYear().toString() : '',
  );
    ...
    <GradientBackground variant="background">
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Animated.View
            style={[styles.avatarContainer, { opacity: avatarOpacity }]}
          >
            <TouchableOpacity
        ...
        {!focusedInput && !isKeyboardVisible && (
          <View style={styles.footer}>
            <TouchableOpacity
              style={[
                styles.nextButton,
                (!name || !day || !month || !year) && styles.nextButtonDisabled,
              ]}
