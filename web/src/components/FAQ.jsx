    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <ChevronDown size={24} className="text-gray-400 group-hover:text-[var(--color-primary)] transition-colors" />
                </motion.div>
            </button>
        ...
        <section className="py-20 bg-white">
            <div className="container px-4">
                <div className="text-center mb-16">
                    <span className="text-[var(--color-primary)] font-bold tracking-wider uppercase text-sm mb-2 block">FAQ</span>
                    <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">Questions? We've Got Answers.</h2>
