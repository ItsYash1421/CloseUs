...
const CTA = () => {
    const handleEarlyAccessClick = () => {
        trackEvent('early_access_clicked_cta');
    };
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                            Join thousands of couples who are building stronger, more meaningful
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                            <Link
                                ...
                                className="group bg-[var(--color-primary)] text-white px-8 py-4 rounded-full font-bold shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center gap-2 text-lg"
                            >
                                Get Early Access
                                <ArrowRight
                                    size={20}
