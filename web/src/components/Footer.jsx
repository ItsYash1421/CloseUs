                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-gray-600 max-w-sm mb-6 leading-relaxed">
                            A private digital space designed purely for two. Grow closer, stay connected, build memories together.
                        </p>
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/closeus_001" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 hover:text-[var(--color-primary)] hover:shadow-md hover:scale-110 transition-all">
                                <Instagram size={20} />
                            </a>
                            <a href="mailto:closeus1421@gmail.com" className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 hover:text-[var(--color-primary)] hover:shadow-md hover:scale-110 transition-all">
                                <Mail size={20} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link to="/features" className="text-gray-600 hover:text-[var(--color-primary)] transition-colors">Features</Link></li>
                            <li><Link to="/pricing" className="text-gray-600 hover:text-[var(--color-primary)] transition-colors">Pricing</Link></li>
                            <li><Link to="/roadmap" className="text-gray-600 hover:text-[var(--color-primary)] transition-colors">Roadmap</Link></li>
                        </ul>
                    </div>
