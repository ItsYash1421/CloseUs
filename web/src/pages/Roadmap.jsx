    ...
    return (
        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
                <div
                    className={`w-12 h-12 ${config.bg} rounded-xl flex items-center justify-center ${config.color}`}
                >
                    <Icon size={24} />
                </div>
                <div>
                    <div className={`text-xs font-bold uppercase ${config.color} mb-1`}>
                        {config.label}
                    </div>
                ...
                <section className="py-20 bg-gradient-to-br from-[#FFE6E1] to-[#FFF5F5]">
                    <div className="container px-4 text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            We're constantly building new features to help couples grow closer.
                            Here's what's live, in progress, and planned for the future.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-20">
                    <div className="container px-4">
                        ...
                        <div className="mt-16 text-center bg-gradient-to-br from-red-50 to-pink-50 p-12 rounded-3xl max-w-4xl mx-auto">
                            <h3 className="text-3xl font-bold mb-4 text-[#2B2B2B]">
                                Have a feature request?
                            </h3>
                            <p className="text-lg text-gray-600 mb-6">
                                We'd love to hear your ideas! Help us build the best app for
                                couples.
                            </p>
                            <a
